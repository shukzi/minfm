...
Pin both the installer and release asset to the same tag. Replace `v0.5.1` in
both places with the version you want:

```sh
curl -fsSL https://github.com/shukzi/minfm/raw/v0.5.1/install.sh | MINFM_VERSION=v0.5.1 sh
minfm
```
